...
void Dispatch(const phxrpc::BaseRequest &req,
    ...
    AdvertisementServiceImpl service(*service_args);
    AdvertisementDispatcher dispatcher(service, args);

    phxrpc::BaseDispatcher<AdvertisementDispatcher> base_dispatcher(
            dispatcher, AdvertisementDispatcher::GetURIFuncMap());
