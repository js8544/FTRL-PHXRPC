...
void Dispatch(const phxrpc::BaseRequest &req,
    ...
    FTRLServiceImpl service(*service_args);
    FTRLDispatcher dispatcher(service, args);

    phxrpc::BaseDispatcher<FTRLDispatcher> base_dispatcher(
            dispatcher, FTRLDispatcher::GetURIFuncMap());
